...
- **★ rev-GARP(round 18)= 迄今最强且最稳**：PB 便宜半数池内按营收增速 rev_yoy 选 top-50(综合 r12 最干净成长 + r14 估值纪律)→ **净超额 +4.76(PASS 最高)、Sharpe 0.87(最高)、train +1.07 / OOS +1.75(双强,OOS 亦居首)、回撤 0.43、be 475bps、Tier-2[2.57..4.69] 全强正无翻转**。关键:**净 vs-EW +0.64(正!)**——连不可投资的等权强基准都跑赢(首个清晰做到的 PASS 轮),大幅强化"非基准依赖"诚实性。营收成长 × 估值纪律 = 最佳综合。**r19 vs csi1000 +4.79 ≈ vs csi300 +4.76 → 赢家亦非规模 beta**。**r20 行业中性版**(每行业 top-3)=最佳风险调整/最易部署:**Sharpe 1.10(全场最高)、回撤 0.21(腰斩)**、换手 9.3%、be 818bps、净超额 +3.76、OOS +0.96(train +1.25),代价=让出 vs-EW(−0.47,行业中性剥离小盘 tilt)。⇒ **两风格**:激进(raw r18,OOS +1.75/beat-EW/DD 0.43) vs 稳健(行业中性 r20,Sharpe 1.10/DD 0.21)。
