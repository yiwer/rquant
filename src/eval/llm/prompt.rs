...
mod tests {
    ...
    fn ctx_with(closes: &[f64], news: Option<NewsView>) -> Context {
        ...
        Context { t: base, primary: Window { bars: bars.clone() }, context: Window { bars }, news, aux: std::collections::BTreeMap::new(), sim: crate::features::context::SimState::default(), fundamentals: std::collections::BTreeMap::new(), eval_cache: Default::default() }
    }
