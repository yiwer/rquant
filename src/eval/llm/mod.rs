...
mod tests {
    ...
    pub(super) fn ctx() -> Context {
        ...
        Context { t, primary: Window { bars: vec![] }, context: Window { bars: vec![] }, news: None, aux: std::collections::BTreeMap::new(), sim: crate::features::context::SimState::default(), fundamentals: std::collections::BTreeMap::new(), eval_cache: Default::default() }
    }
